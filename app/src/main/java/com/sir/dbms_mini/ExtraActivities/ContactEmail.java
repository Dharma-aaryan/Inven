...
public class ContactEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email = "aaryan.dhams@gmail.com";
                if (subject.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Please add Subject", Toast.LENGTH_SHORT).show();
                } else if (message.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Please add some Message", Toast.LENGTH_SHORT).show();
                } else {
